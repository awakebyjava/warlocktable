...
// Device pattern name: Aura-Tower
// Pattern id: 5Gzx92LDzrPSS8E3B
...
// Aura-Tower -- GENERATED by tools/patterngen.py. Do not edit here.
...
export function beforeRender(delta) {
  dt = delta / 1000
  env = 0
  if (square(time(0.00336), 0.35) > 0) env = 1
}
