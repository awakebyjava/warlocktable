...
DEFAULT_RAW = Path("audio/entity/_test/audition__raw.mp3")
FALLBACK_RAW = Path("audio/entity/_test/system_shutdown_01__raw.mp3")
...
def main():
    ...
    if paths:
        ...
        raw = DEFAULT_RAW if DEFAULT_RAW.exists() else FALLBACK_RAW

    if not raw.exists():
        sys.exit(f"Can't find {raw}\n"
