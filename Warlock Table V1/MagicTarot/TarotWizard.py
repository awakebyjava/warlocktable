...
if __name__ == "__main__":
    ...
    aceofpentaclesPattern = "glitch bands"
    ...
    #pb.setSequencerMode()              # make sure the sequencer isn't running    
...
while True:
    ...
    if uid == test1:
        ...
        pygame.mixer.music.stop()
        pygame.mixer.music.load('/home/pi/Documents/MagicTarot/Ov/crowley2.ogg')
        pygame.mixer.music.play(-1);
        ...
        pygame.mixer.music.stop()
        pygame.mixer.music.load('/home/pi/Documents/MagicTarot/Ov/javan4.ogg')
        pygame.mixer.music.play(-1);
        ...
        pygame.mixer.music.stop()
        pygame.mixer.music.load('/home/pi/Documents/MagicTarot/Ov/september4.ogg')
        pygame.mixer.music.play(-1);
    elif uid == forest:
        print('forest')
        pb.setActivePattern(forestPattern)
        pygame.mixer.music.stop()
        pygame.mixer.music.load('/home/pi/Documents/MagicTarot/MagicCards/forest.ogg')
        pygame.mixer.music.play(-1);
    elif uid == island:
        print('island')
        pb.setActivePattern(islandPattern)
        pygame.mixer.music.stop()
        pygame.mixer.music.load('/home/pi/Documents/MagicTarot/MagicCards/island.ogg')
        pygame.mixer.music.play(-1);
    elif uid == mountain:
        print('mountain')
        pb.setActivePattern(mountainPattern)
        pygame.mixer.music.stop()
        pygame.mixer.music.load('/home/pi/Documents/MagicTarot/MagicCards/mountain.ogg')
        pygame.mixer.music.play(-1);
    elif uid == swamp:
        print('swamp')
        pb.setActivePattern(swampPattern)
        pygame.mixer.music.stop()
        pygame.mixer.music.load('/home/pi/Documents/MagicTarot/MagicCards/swamp.ogg')
        pygame.mixer.music.play(-1);
    elif uid == plains:
        print('plains')
        pb.setActivePattern(plainsPattern)
        pygame.mixer.music.stop()
        pygame.mixer.music.load('/home/pi/Documents/MagicTarot/MagicCards/plains.ogg')
        pygame.mixer.music.play(-1);
    else:
